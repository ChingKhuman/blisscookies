            ...
            <div className="container clearfix">
              ...
              >
                ...
                <ul className="nav navbar-nav nav1">
                  ...
                  <li>
                    <Link to={""}>
                      Cake Categories<i className="fa fa-chevron-down"></i>
                    </Link>
                    <ul className="sub-menu">
                      <li>
                        <Link to={"/our-menu-1"}>Category 1</Link>
                      </li>
                      <li>
                        <Link to={"/our-menu-2"}>Category 2</Link>
                      </li>
                      <li>
                        <Link to={"/our-menu-3"}>Category 3</Link>
                      </li>
                      <li>
                        <Link to={"/our-menu-4"}>Category 4</Link>
                      </li>
                    </ul>
                  </li>
                </ul>
