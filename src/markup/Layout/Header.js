					...
					<div className="main-bar clearfix ">
						<div className="container clearfix">
							...
							<div className="logo-header mostion">
								<Link to={'/Shop'} className="dez-page"><img src={require('./../../images/logo9.1.png')} alt="" /></Link>
							</div>
							...
							<div className="header-nav navbar-collapse navbar myNavbar collapse justify-content-between" id="navbarNavDropdown">
								...
								<ul className="nav navbar-nav nav1">	
									...
									<li><Link to={'/shop'}>HomePage</Link></li>
									...
									<li><Link to={''}>Category<i className="fa fa-chevron-down"></i></Link>
										<ul className="sub-menu">
											<li><Link to ={'/our-menu-1'}>Category 1</Link></li>
											<li><Link to ={'/our-menu-2'}>Category 2</Link></li>
											<li><Link to ={'/our-menu-3'}>Category 3</Link></li>
											<li><Link to ={'/our-menu-4'}>Category 4</Link></li>
										</ul>
									</li>
								</ul>
