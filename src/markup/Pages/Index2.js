			...
			<div>
				<div class="page-wraper font-barlow">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-6 col-md-12">
									<div class="adv-box">
										<Link to={"/shop-sidebar"}><img src={require("./../../images/ads/cakeimg20.jpg")} alt="" /></Link>
									</div>
								</div>
								<div class="col-lg-6 col-md-12">
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<div class="adv-box">
												<Link to={"/shop-sidebar"}><img src={require("./../../images/ads/cakeimg8.jpg")} alt="" /></Link>
											</div>
										</div>
										<div class="col-lg-6 col-md-6">
											<div class="adv-box">
												<Link to={"/shop-sidebar"}><img src={require("./../../images/ads/cakeimg24.jpg")} alt="" /></Link>
											</div>
										</div>
					...
					<div class="section-full bg-white">
						<div class="row sp0">
							<div class="col-lg-6">
								<img src={require("./../../images/menu/cakeimg5.jpg")} alt="" class="img-cover" />
							</div>
							<div class="col-lg-6">
								<div class="menu-box">
						...
						<div class="row manu-box-reverse sp0">
							<div class="col-lg-6">
								<div class="menu-box">
									<div class="section-head style-2">
										<h4 class="sub-title">Bliss Menu</h4>
										<h2 class="title">Festive Season Offers</h2>
									</div>
									<ul class="menu-list-2">
										<li>
											<div class="info-price">
												<h5 class="title">Vanilla Cake</h5>
												<div class="line"></div>
												<span class="price">14.99</span>
											</div>
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
										...
										<li>
											<div class="info-price">
												<h5 class="title">Apricot Cake</h5>
												<div class="line"></div>
												<span class="price">07.99</span>
											</div>
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
										...
										<li>
											<div class="info-price">
												<h5 class="title">Chocolate cake</h5>
												<div class="line"></div>
												<span class="price">14.99</span>
											</div>
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
										...
										<li>
											<div class="info-price">
												<h5 class="title">Liguria Cake</h5>
												<div class="line"></div>
												<span class="price">22.99</span>
											</div>
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
					...
					<div class="section-full bg-white pizza-full-menu">
						<img src={require("./../../images/ads/bg.png")} alt="" />
					</div>  
						...
						<div class="container">
							<div class="row align-items-center">
								<div class="col-md-6 text-white">
									<h5 class="m-b0">Love Cake? Like deals? Be the first to know about our newest menu items and latest offers. More food. less money.</h5>
								</div>
								<div class="col-md-6">
