...
var serblog2 = require('./../../images/our-services/cakeimg10.jpg');
var serblog3 = require('./../../images/our-services/cakeimg6.jpg');
var serblog4 = require('./../../images/our-services/cakeimg16.jpg');
...
class Homeeg extends Component{
							...
							<div className="container">
								...
								<div className="row">
									<div className="col-lg-4 m-b30">
										<img src={require('./../../images/about/cakeimg25.jpg')} className="img-cover radius-sm" alt="" />
									</div>
							...
							<div className="container-fluid">
								<div className="row">
									<div className="col-lg-3 col-md-6 col-sm-6">
										<div className="port-box1 text-white">
											<div className="dlab-media">
												<img src={require('./../../images/our-work/cakeimg11.jpg')} alt="" />
											</div>
									...
									<div className="col-lg-3 col-md-6 col-sm-6">
										<div className="port-box1 text-white">
											<div className="dlab-media">
												<img src={require('./../../images/our-work/cakeimg6.jpg')} alt="" />
											</div>
											<div className="dlab-info">
									...
									<div className="col-lg-3 col-md-6 col-sm-6">
										<div className="port-box1 text-white">
											<div className="dlab-media">
												<img src={require('./../../images/our-work/cakeimg9.jpg')} alt="" />
											</div>
											<div className="dlab-info">
									...
									<div className="col-lg-3 col-md-6 col-sm-6">
										<div className="port-box1 text-white m-md-b0 m-sm-b0">
											<div className="dlab-media">
												<img src={require('./../../images/our-work/cakeimg7.jpg')} alt="" />
											</div>
											<div className="dlab-info">
							...
							<div className="container">
								<div className="row m-lr0 about-area1">
									<div className="col-lg-6 p-lr0">
										<img className="img-cover" src={require('./../../images/about/cakeimg3.jpg')} alt="" />
									</div>
