				...
				<div className="section-full bg-white">
					<div className="row sp0">
						<div className="col-lg-6">
							<img src={require('./../../images/menu/cakeimg5.jpg')} alt="" className="img-cover" />
						</div>
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									<h4 className="sub-title">Cake Menu</h4>
									<h2 className="title">RestroKing Pizza, The Best In Town</h2>
								</div>
								<ul className="menu-list-2">
									<li>
										<div className="info-price">
											<h5 className="title">Pepperoni Cake</h5>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Apricot Cake</h5>
											<div className="line"></div>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Cake Veronese</h5>
											<div className="line"></div>
											<span className="price">14.99</span>
										</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.</p>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Summer Cake</h5>
											<div className="line"></div>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Liguria Cake</h5>
											<div className="line"></div>
