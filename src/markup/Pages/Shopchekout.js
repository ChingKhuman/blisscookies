						...
						<div className="row">
							<div className="col-lg-6">
								...
								<table className="table-bordered check-tbl">
									...
									<tbody>
										<tr>
											<td><img src={require('./../../images/product/cakeimg10.jpg')} alt="" /></td>
											<td>Cup Cake</td>
											<td className="product-price">$28.00</td>
										</tr>
										<tr>
											<td><img src={require('./../../images/product/cakeimg8.jpg')} alt="" /></td>
											<td>Pizza</td>
											<td className="product-price">$36.00</td>
										</tr>
										<tr>
											<td><img src={require('./../../images/product/cakeimg6.jpg')} alt="" /></td>
											<td>Burger</td>
											<td className="product-price">$28.00</td>
										</tr>
										<tr>
											<td><img src={require('./../../images/product/cakeimg13.jpg')} alt="" /></td>
											<td>Chow Mein</td>
											<td className="product-price">$36.00</td>
										</tr>
										<tr>
											<td><img src={require('./../../images/product/cakeimg14.jpg')} alt="" /></td>
											<td>Pizza</td>
											<td className="product-price">$28.00</td>
										</tr>
									</tbody>
