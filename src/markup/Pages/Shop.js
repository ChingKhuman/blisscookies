						...
						<div className="container">
							<div className="row">
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg8.jpg')} alt="" />
											<div className="price">
												$35.00 
											</div>
										</div>
										<div className="item-info text-center">
											...
											<i className="ti-shopping-cart m-r5"></i> Add To Cart</Link>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg6.jpg')} alt="" />
								...
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg25.jpg')} alt="" />
											<div className="price">
												$20.00 
											</div>
										</div>
								...
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg14.jpg')} alt="" />
											<div className="price">
												$18.00 
											</div>
										</div>
								...
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg13.jpg')} alt="" />
										</div>
										<div className="item-info text-center">
								...
								<div className="col-lg-3 col-md-6 col-sm-6">
									<div className="item-box shop-item">
										<div className="item-img">
											<img src={require('./../../images/product/cakeimg10.jpg')} alt="" />
											<div className="price">
												$35.00 
											</div>
										</div>
